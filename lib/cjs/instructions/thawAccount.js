 ...
 */
function createThawAccountInstruction(account, mint, authority, multiSigners = [], programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
 ...
 */
function decodeThawAccountInstruction(instruction, programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
