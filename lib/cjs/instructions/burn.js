 ...
 */
function createBurnInstruction(account, mint, owner, amount, multiSigners = [], programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
 ...
 */
function decodeBurnInstruction(instruction, programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
