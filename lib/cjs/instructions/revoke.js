 ...
 */
function createRevokeInstruction(account, owner, multiSigners = [], programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
 ...
 */
function decodeRevokeInstruction(instruction, programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
