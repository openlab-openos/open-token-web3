 ...
 */
function createMintToCheckedInstruction(mint, destination, authority, amount, decimals, multiSigners = [], programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
 ...
 */
function decodeMintToCheckedInstruction(instruction, programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
