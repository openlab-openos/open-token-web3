 ...
 */
function createTransferInstruction(source, destination, owner, amount, multiSigners = [], programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
 ...
 */
function decodeTransferInstruction(instruction, programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
