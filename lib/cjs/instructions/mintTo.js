 ...
 */
function createMintToInstruction(mint, destination, authority, amount, multiSigners = [], programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
 ...
 */
function decodeMintToInstruction(instruction, programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
