...
function getMultipleAccounts(connection_1, addresses_1, commitment_1) {
    return __awaiter(this, arguments, void 0, function* (connection, addresses, commitment, programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
 ...
 */
function unpackAccount(address, info, programId = constants_js_1.TOKEN_2022_PROGRAM_ID) {
    if (!info)
